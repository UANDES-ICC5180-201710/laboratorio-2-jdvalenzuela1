...
class CourseStudentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_student" do
    assert_difference('CourseStudent.count') do
      post course_students_url, params: { course_student: { course_id: @course_student.course_id, person_id: @course_student.person_id } }
    end
  ...
  test "should update course_student" do
    patch course_student_url(@course_student), params: { course_student: { course_id: @course_student.course_id, person_id: @course_student.person_id } }
